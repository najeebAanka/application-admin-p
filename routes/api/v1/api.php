...
Route::group(['namespace' => 'api\v1', 'prefix' => 'v1', 'middleware' => ['cors', 'api_lang']], function () {
    ...
    Route::group(['prefix' => 'config'], function () {
        ...
        Route::get('/web', 'ConfigController@configurationWeb');
        Route::get('/categories_home_top', 'ConfigController@categories_home_top');
        Route::get('/categories_home', 'ConfigController@categories_home');
        Route::get('/banners', 'ConfigController@banners');
    });
    ...
    Route::group(['prefix' => 'products'], function () {
        ...
        Route::get('auto-complete', 'ProductController@autoComplete');
        Route::get('recently-viewed', 'ProductController@recentlyViewed');
        ...
        Route::get('home-sections', 'ProductController@home_sections');
        Route::get('home-sections-mobile', 'ProductController@home_sections_mobile');
    });
    ...
    Route::group(['prefix' => 'categories'], function () {
        Route::get('/{id?}', 'CategoryController@get_categories');
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        ...
        Route::group(['prefix' => 'kitchen'], function () {
            Route::get('list', 'CustomerController@kitchen_list');
            Route::post('add', 'CustomerController@add_new_kitchen');
        });
        ...
        Route::group(['prefix' => 'wish-list'], function () {
            ...
            Route::post('remove', 'CustomerController@remove_from_wishlist');
        });
        ...
        Route::group(['prefix' => 'order'], function () {
            ...
            Route::post('status', 'OrderController@status_order');
        });
        // Chatting
    ...
    Route::group(['prefix' => 'seller', 'middleware' => 'auth:api'], function () {
        Route::get('fav', 'SellerController@fav');
        Route::post('fav', 'SellerController@get_all_fav_sellers');
    });

    Route::group(['prefix' => 'coupon', 'middleware' => 'auth:api'], function () {
        Route::get('apply', 'CouponController@apply');
        Route::get('used', 'CouponController@getUsed');
    });
