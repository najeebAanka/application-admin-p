...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'category', 'as' => 'category.','middleware'=>['module:product_management']], function () {
            ...
            Route::get('status-top/{id}/{home_top}', 'CategoryController@statusTop')->name('statusTop');
            Route::get('home-section/{id}/{home_section}', 'CategoryController@homeSection')->name('home_section');
            Route::get('is_mad_test/{id}/{is_mad_test}', 'CategoryController@is_mad_test')->name('is_mad_test');
        });
        ...
        Route::group(['prefix' => 'banner', 'as' => 'banner.','middleware'=>['module:marketing_section']], function () {
            ...
            Route::post('is_mad_test', 'BannerController@is_mad_test')->name('is_mad_test');
            Route::get('view/{id}', 'BannerController@view')->name('view');
            Route::get('edit/{id}', 'BannerController@edit')->name('edit');
            Route::put('update/{id}', 'BannerController@update')->name('update');
        });


        Route::group(['prefix' => 'kitchen', 'as' => 'kitchen.','middleware'=>['module:marketing_section']], function () {
            Route::post('add-new', 'KitchenController@store')->name('store');
            Route::get('list', 'KitchenController@list')->name('list');
            Route::post('delete', 'KitchenController@delete')->name('delete');
            Route::post('status', 'KitchenController@status')->name('status');
            Route::get('view/{id}', 'KitchenController@view')->name('view');
            Route::get('edit/{id}', 'KitchenController@edit')->name('edit');
            Route::put('update/{id}', 'KitchenController@update')->name('update');
        });

        Route::group(['prefix' => 'home-sections', 'as' => 'home-sections.','middleware'=>['module:marketing_section']], function () {
            Route::post('add-new', 'HomeSectionsController@store')->name('store');
            Route::get('list', 'HomeSectionsController@list')->name('list');
            Route::post('delete', 'HomeSectionsController@delete')->name('delete');
            Route::post('status', 'HomeSectionsController@status')->name('status');
            Route::post('is_mad_test', 'HomeSectionsController@is_mad_test')->name('is_mad_test');
            Route::get('edit/{id}', 'HomeSectionsController@edit')->name('edit');
            Route::put('update/{id}', 'HomeSectionsController@update')->name('update');
        });
