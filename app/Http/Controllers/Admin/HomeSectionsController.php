...
class HomeSectionsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $home_section->color = $request->color;
    ...
    public function is_mad_test(Request $request)
    {
        if ($request->ajax()) {
            ...
            $banner->is_mad_test = $request->is_mad_test;
            $banner->save();
            $data = $request->status;
            return response()->json($data);
        }
    ...
    public function update(Request $request,$id)
    {
        ...
        if($request->file('image')) {
            $home_section->photo = ImageManager::update('home-section/', $home_section['photo'], 'png', $request->file('image'));
        }
        $home_section->save();
