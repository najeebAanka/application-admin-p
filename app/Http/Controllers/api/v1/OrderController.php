...
class OrderController extends Controller
{
    public function track_order(Request $request)
    {
        ...
        return Helpers::sendSuccess(translate('Data Got!'), OrderManager::track_order($request['order_id']));
    }
    ...
    public function status_order(Request $request)
    {
        ...
        Order::where('id', $request->order_id)->where('customer_id', auth('api')->user()->id)->update([
            'order_status' => $request->status
        ]);


        return Helpers::sendSuccess(translate('Order Canceled!'), []);
    }
    ...
    public function place_order(Request $request)
    {
        ...
        return Helpers::sendSuccess(translate('order_placed_successfully'), '');
    }
}
