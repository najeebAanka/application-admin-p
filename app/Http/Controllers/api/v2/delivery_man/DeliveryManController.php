...
class DeliveryManController extends Controller
{
    ...
    public function record_location_data(Request $request)
    {
        ...
        return Helpers::sendSuccess(translate('location recorded'), '');
    }
    ...
    public function get_order_history(Request $request)
    {
        ...
        return Helpers::sendSuccess(translate("Data Got!"), $history);
    }
    ...
    public function update_order_status(Request $request)
    {
        ...
        return Helpers::sendSuccess(translate('Status updated'), '');
    }
    ...
    public function get_last_location(Request $request)
    {
        ...
        return Helpers::sendSuccess(translate("Data Got!"), $last_data);
    }
