...
class SocialAuthController extends Controller
{
    public function social_login(Request $request)
    {
        ...
        try {
            ...
            return Helpers::sendError([['message' => 'wrong credential.']], $exception->getCode());
        }
        ...
        if (strcmp($email, $data['email']) === 0) {
            ...
            if (!isset($user->phone)) {
                return Helpers::sendSuccess('update phone number', [
            ...
            if ($token != null) {
                return Helpers::sendSuccess('Data Got!', ['token' => $token]);
            }
    ...
    public function update_phone(Request $request)
    {
        ...
        if ($phone_verification->value == 1) {
            ...
            return Helpers::sendSuccess('Phone number updated successfully', '');
        }
    }
