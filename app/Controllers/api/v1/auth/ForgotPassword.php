...
class ForgotPassword extends Controller
{
    public function reset_password_request(Request $request)
    {
        ...
        if ($verification_by == 'email') {
            ...
            if (isset($customer)) {
                ...
                return Helpers::sendSuccess('Email sent successfully.', '');
            }
            ...
            if (isset($customer)) {
                ...
                return Helpers::sendSuccess('otp sent successfully.', '');
            }
        }
        return Helpers::sendError([['code' => 'not-found', 'message' => 'user not found!']], 404);
    }
    ...
    public function otp_verification_submit(Request $request)
    {
        ...
        if ($validator->fails()) {
            return Helpers::sendSuccess('otp verified.', '');
        }
        ...
        return Helpers::sendError([['code' => 'not-found', 'message' => 'invalid OTP']], 404);
    }
    ...
    public function reset_password_submit(Request $request)
    {
        ...
        if (isset($data)) {
            ...
            return Helpers::sendSuccess('Password changed successfully.', '');
        }

        return Helpers::sendError([['code' => 'invalid', 'message' => 'Invalid token.']], 501);
    }
}
