...
class ShippingMethodController extends Controller
{
    public function get_shipping_method_info($id)
    {
        try {
            ...
            return Helpers::sendSuccess("Data Got!",$shipping);
        } catch (\Exception $e) {
    ...
    public function shipping_methods_by_seller($id, $seller_is)
    {
        ...
        return Helpers::sendSuccess('Data got!',Helpers::get_shipping_methods($id, $seller_is));
    }
    ...
    public function chosen_shipping_methods(Request $request)
    {
        ...
        return Helpers::sendSuccess('Data Got!',CartShipping::whereIn('cart_group_id', $group_ids)->get());
    }
}
