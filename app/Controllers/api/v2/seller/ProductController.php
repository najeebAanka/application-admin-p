...
class ProductController extends Controller
{
    public function list(Request $request)
    {
        ...
        return Helpers::sendSuccess('Data Got!', Product::where(['added_by' => 'seller', 'id' => $seller['id']])->get());
    }
    ...
    public function upload_images(Request $request)
    {
        ...
        return Helpers::sendSuccess("Data Got!", ['image_name' => $image, 'type' => $request['type']]);
    }
