                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select style="width: 100%"
                                                ...
                                                <option value="Account Banner">Account Banner</option>
                                                <option value="Cart Banner">Cart Banner</option>
                                            </select>
                                        </div>
                                ...
                                @foreach($banners as $key=>$banner)
                                    ...
                                    <tr>
                                        ...
                                        <td><label class="switch"><input type="checkbox" class="is_mad_test"
                                                                         id="{{$banner->id}}is_mad_test" <?php if ($banner->is_mad_test == 1) echo "checked" ?>><span
                                                        class="slider round"></span></label></td>
                                        <td>
                                            <div class="dropdown">
...
@push('script')
    ...
    <script>
        ...
        $(document).on('change', '.is_mad_test', function () {
            ...
            $.ajax({
                url: "{{route('admin.banner.is_mad_test')}}",
                method: 'POST',
                data: {
