                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select style="width: 100%"
                                                ...
                                                <option value="Main Banner" {{$banner['banner_type']=='Main Banner'?'selected':''}}>
                                                    Main Banner
                                                </option>
                                                <option value="Footer Banner" {{$banner['banner_type']=='Footer Banner'?'selected':''}}>
                                                    Footer Banner
                                                </option>
                                                <option value="Offer Banner" {{$banner['banner_type']=='Offer Banner'?'selected':''}}>
                                                    Offer Banner
                                                </option>
                                                <option value="Home Section" {{$banner['banner_type']=='Home Section'?'selected':''}}>
                                                    Home Section
                                                </option>
                                                <option value="Account Banner" {{$banner['banner_type']=='Account Banner'?'selected':''}}>
                                                    Account Banner
                                                </option>
                                                <option value="Cart Banner" {{$banner['banner_type']=='Cart Banner'?'selected':''}}>
                                                    Cart Banner
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select style="width: 100%" onchange="display_data(this.value)"
                                                ...
                                                <option value="category" {{$banner['resource_type']=='category'?'selected':''}}>
                                                    Category
                                                </option>
