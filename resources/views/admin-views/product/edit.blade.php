                            ...
                            @foreach(json_decode($language) as $lang)
                                ...
                                if (count($product['translations'])) {
                                    ...
                                    foreach ($product['translations'] as $t) {
                                        ...
                                        if ($t->locale == $lang && $t->key == "features") {
                                            $translate[$lang]['features'] = $t->value;
                                        }
                                ...
                                <div class="{{$lang != 'en'? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                    ...
                                    <div class="form-group pt-4">
                                        <label class="input-label">{{\App\CPU\translate('features')}}
                                            ({{strtoupper($lang)}})</label>
                                        <textarea name="features[]" style="display:none" class="textarea"
                                                  required>{!! $translate[$lang]['features']??$product['features'] !!}</textarea>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <label for="name">{{\App\CPU\translate('Model')}}</label>
                                        <input type="text" name="model" value="{{$product->model}}"
                                               id="model" class="form-control" placeholder="{{\App\CPU\translate('Model')}}" required>
                                    </div>
                    ...
                    <div class="card mt-2 rest-part">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{\App\CPU\translate('Upload product images')}}</label>
                                        <small
                                                style="color: red">* ( {{\App\CPU\translate('ratio')}} 1:1 )
                                        </small>
                                    </div>
