                    ...
                    <div class="card-body"
                        ...
                        <form action="{{route('admin.category.update',[$category['id']])}}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 from_part_2">
                                    <label>{{\App\CPU\translate('choose')}} {{\App\CPU\translate('Products Style')}}</label>
                                    <div style="text-align: left">
                                        <select class="form-control" name="products_style" id="products_style">
                                            <option value="1" {{$category['products_style']==1?'selected':''}}>
                                                Vertical
                                            </option>
                                            <option value="2" {{$category['products_style']==2?'selected':''}}>
                                                Horizontal
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-4 from_part_2">
                                    <label>{{\App\CPU\translate('choose')}} {{\App\CPU\translate('Is Gift?')}}</label>
                                    <div style="text-align: left">
                                        <select class="form-control" name="is_gift" id="is_gift">
                                            <option value="1" {{$category['is_gift']==1?'selected':''}}>
                                                Yes
                                            </option>
                                            <option value="0" {{$category['is_gift']==0?'selected':''}}>
                                                No
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-4 from_part_2">
                                    <label>{{\App\CPU\translate('banner')}}</label>
                                    <small style="color: red">
                                        ( {{\App\CPU\translate('ratio')}} 3:1 )
                                    </small>
                                    <div class="custom-file" style="text-align: left">
                                        <input type="file" name="banner" id="customFileEg12"
                                               class="custom-file-input"
                                               accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label"
                                               for="customFileEg12">{{\App\CPU\translate('choose')}} {{\App\CPU\translate('file')}}</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 from_part_2">
                                    <div class="form-group">
                                        ...
                                        <center>
                                            <img style="width: 30%;border: 1px solid; border-radius: 10px;"
                                                 id="viewer2"
                                                 src="{{asset('storage/category')}}/{{$category['banner']}}"
                                                 alt=""/>
                                        </center>
                                    </div>
                                </div>
