                ...
                <div class="container mt-2">
                    <div class="row p-0">
                        <div class="col-md-3 p-0 text-center mobile-padding mt-1 mt-md-0">
                            <img style="height: 29px;" src="{{asset("/assets/front-end/png/delivery.png")}}"
                                 alt="">
                        ...
                        <div class="col-md-3 p-0 text-center mt-1 mt-md-0">
                            <img style="height: 29px;" src="{{asset("/assets/front-end/png/Genuine.png")}}"
                                 alt="">
                            <div class="deal-title">100% {{\App\CPU\translate('genuine')}}
                                <br><span>{{\App\CPU\translate('product')}}</span></div>
                        </div>
                        <div class="col-md-3 p-0 text-center mt-1 mt-md-0">
                            <img style="height: 29px;" src="{{asset("/assets/front-end/png/Payment.png")}}"
                                 alt="">
