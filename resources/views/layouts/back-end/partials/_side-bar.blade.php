...
<!--                        <li class="nav-item">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/kitchen*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.kitchen.list')}}">
                                    ...
                                    <span
                                            class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('kitchens')}}</span>
                                </a>
                            </li>
                        @endif
                    ...
                    <!--product management ends-->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('marketing_section'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/home-sections*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.home-sections.list')}}">
                                    <i class="tio-photo-square-outlined nav-icon"></i>
                                    <span
                                            class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('Home Sections')}}</span>
                                </a>
                            </li>
